...
class BaseSetroptsTraits(TraitsBase):
    ...
    uncataloged_dataset_access: str | None = field(default=None,metadata={"allowed_in": {"alter","extract"}})
    ...
    erase_datasets_on_delete_all: str | None = field(default=None,metadata={"allowed_in": {"alter","extract"}})
    erase_datasets_on_delete_security_level: str | None = field(default=None,metadata={"allowed_in": {"alter","extract"}})
    ...
    dataset_single_level_name_prefix_protection: str | None = field(default=None,metadata={"allowed_in": {"alter","extract"}})
    ...
    protect_all_datasets: str | None = field(default=None,metadata={"allowed_in": {"alter","extract"}})
    ...
    tape_dataset_security_retention_period: int | None = field(default=None,metadata={"label": "Tape dataset security retention period","allowed_in": {"alter","extract"},"input_args": {"classes": "field-medium-generic"}})
    ...
    #automatic_dataset_protection: bool | None = field(default=None,metadata={"label": "Automatic dataset protection", "allowed_in": {"alter","extract"}, "input_args": {"classes": "generic-checkbox-medium"}})
    ...
    tape_dataset_protection: bool | None = field(default=None,metadata={"label": "Tape dataset protection","allowed_in": {"alter","extract"}, "input_args": {"classes": "generic-checkbox-medium"}})
    #erase_datasets_on_delete: bool | None = field(default=None,metadata={"label": "Erase datasets on deletion","allowed_in": {"alter","extract"}, "input_args": {"classes": "generic-checkbox-medium"}})
    log_real_dataset_name: bool | None = field(default=None,metadata={"label": "Log real dataset names", "allowed_in": {"alter","extract"}, "input_args": {"classes": "generic-checkbox-medium"}})
