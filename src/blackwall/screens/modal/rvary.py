...
class RvaryScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield Grid(
            ...
            Input(id="rvary_password",restrict=r"(\w*[\@\#\$]*)",placeholder="enter password...",max_length=8,password=True),
            Input(id="rvary_password_confirm",restrict=r"(\w*[\@\#\$]*)",placeholder="confirm password..\w*\d*[@#$].",max_length=8,password=True),
