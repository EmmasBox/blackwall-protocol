...
class RvaryScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield Grid(
            ...
            Input(id="rvary_password",restrict=r"(\w*\d*[\@\#\$\*])",placeholder="enter password...",max_length=8,password=False),
            Input(id="rvary_password_confirm",placeholder="confirm password..\w*\d*[@#$].",max_length=8,password=True),
